        ...
        <div class="">
            <form method="post" action="{{route('factor.create')}}">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="num" id="num" class="form-control" placeholder="شماره فاکتور" required>
                </div>
                <div class="form-group">
                    <label for="name">نام</label>
                    <input type="text" name="customer" id="name" class="form-control" placeholder="نام" required>
                </div>
                <div class="form-group">
                    <label for="price">هزینه</label>
                    <input type="text" name="price" id="price" class="form-control" placeholder="هزینه" required>
                </div>
                <div class="form-group">
